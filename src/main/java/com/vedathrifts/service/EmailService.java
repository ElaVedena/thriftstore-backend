...
public class EmailService {
    ...
    // NEW METHOD: Send contact form email
                ...
                <body>
                    <div class="container">
                        ...
                        <div class="content">
                            ...
                            <a href="mailto:%s" class="reply-btn">✉️ Reply to Customer</a>
                        </div>
                        <div class="footer">
            ...
            String customerHtml = String.format("""
                ...
                <head>
                    ...
                    <style>
                        ...
                        .social-icons a { color: #CEABB1; text-decoration: none; margin: 0 10px; }
                    </style>
                </head>
                <body>
                    <div class="container">
                        ...
                        <div class="content">
                            ...
                            <ul>
                                <li>🛍️ Browse our latest <a href="http://localhost:3000/shop" style="color: #CEABB1;">thrift collection</a></li>
                                <li>📱 Follow us on <a href="https://instagram.com/vedathrifts" style="color: #CEABB1;">Instagram</a> for daily updates</li>
                                <li>❓ Check out our <a href="http://localhost:3000/faq" style="color: #CEABB1;">FAQ page</a> for quick answers</li>
                            </ul>
                            ...
                            <div class="social-icons">
                                <p>Connect with us:</p>
                                <a href="https://instagram.com/vedathrifts"><i class="fab fa-instagram"></i> Instagram</a> |
                                <a href="https://facebook.com/vedathrifts"><i class="fab fa-facebook"></i> Facebook</a>
                            </div>
                            
                            <p style="margin-top: 20px;">Warm regards,<br><strong>The VedaThrifts Team</strong></p>
                        </div>
                        <div class="footer">
                            <p>© 2024 VedaThrifts. All rights reserved.</p>
    ...
    public void sendWelcomeEmail(User user) {
        ...
        try {
            ...
            context.setVariable("shopUrl", "http://localhost:3000/shop");
    ...
    public void sendOrderConfirmationEmail(Order order, User user) {
        ...
        try {
            ...
            context.setVariable("orderUrl", "http://localhost:3000/orders/" + order.getOrderNumber());
